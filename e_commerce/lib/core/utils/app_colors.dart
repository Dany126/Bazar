...
class AppColors {
  ...
  static const kTextColor = Color(0xFF24261F);

  /// Canvas — main screen background.
  static const kMainBackgroundColor = Color(0xFFEDE7D4);

  /// Paper — card / surface background, sits on top of canvas.
  static const kCardBackgroundColor = Color(0xFFFBF8F0);

  /// Brass — primary accent (buttons, active states, prices).
  static const kPrimaryAccentColor = Color(0xFFB8892B);
  static const kPrimaryAccentColorDark = Color(0xFF8C6A1F);
  ...
  static const kSecondaryTextColor = Color(0xFF7A755F);
}
